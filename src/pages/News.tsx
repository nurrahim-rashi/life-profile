function News() {
  return (
    <section className="max-w-6xl mx-auto px-6 py-20">
      {/* Title */}
      <h1 className="text-5xl font-bold text-center mb-12">News</h1>
      ...
      <div className="carousel w-full rounded-3xl overflow-hidden shadow-lg">
        ...
        <div id="item1" className="carousel-item w-full relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-black/40 text-white p-8">
            ...
            <p className="mt-2 text-sm text-white/80">
              Get 20% off your first private pilates session this month. Limited
              slots available.
            </p>
          </div>
        </div>
        ...
        <div id="item2" className="carousel-item w-full relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-black/40 text-white p-8">
            ...
            <p className="mt-2 text-sm text-white/80">
              Join our exclusive weekend reformer pilates sessions designed for
        ...
        <div id="item4" className="carousel-item w-full relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-black/40 text-white p-8">
            <h2 className="text-3xl font-bold">Studio Upgrade Announcement</h2>
            <p className="mt-2 text-sm text-white/80">
              We have upgraded our equipment and studio environment for a better
              pilates experience.
            </p>
          </div>
        </div>
